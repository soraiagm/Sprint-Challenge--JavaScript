...
*/
const animalNames = zooAnimals.forEach(function(id){
  console.log(id.animal_name, id.scientific_name);
});
...
*/
const largerPopulation = zooAnimals.filter(function(id){
  if (id.population < 5){
    return true;
  }
});
...
const populationTotal = zooAnimals.reduce((total, currentValue) => {
  return total + currentValue.population;}, 0);
